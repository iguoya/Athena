                        ...
                        Column {
                            ...
                            Row {
                                ...
                                Rectangle {
                                    ...
                                    radius: 9
                                    color: "transparent"
                                    border.color: atlas.chapterMasteryColor(modelData.mastery)
                                    MapText {
                                        id: gradeText
                                        anchors.centerIn: parent
                                        text: atlas.chapterMasteryLabel(modelData.mastery)
                                        color: atlas.chapterMasteryColor(modelData.mastery)
                                        font.pixelSize: 11
                                    }
                                }
                            }
        ...
        MapText {
            ...
            text: root.selected
                  ? ((root.selected.kind === "practice" ? "实践" : "理论")
                     + " · " + atlas.chapterMasteryLabel(root.selected.mastery)
                     + " · " + atlas.chapterMasteryHint(root.selected.mastery)
                     + "  "
