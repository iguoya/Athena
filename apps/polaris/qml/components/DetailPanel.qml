...
Rectangle {
    ...
    ScrollView {
        ...
        ColumnLayout {
            ...
            ColumnLayout {
                visible: !root.hasNode && polaris.selectedMapTheory.length > 0
                Layout.fillWidth: true
                spacing: 10
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    height: 4
                    radius: 2
                    color: polaris.trackColor(root.node.track || "")
                }
                Text {
                    Layout.fillWidth: true
                    ...
                    delegate: ColumnLayout {
                        ...
                        Text {
                            ...
                            TapHandler {
                                ...
                                onTapped: {
                                    polaris.openMap(modelData.map_id)
                                    polaris.selectNode(modelData.peer_id)
                                }
                            }
                        }
                        Text {
