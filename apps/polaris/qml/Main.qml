...
ApplicationWindow {
    ...
    function openMap(mapId) {
        ...
        polaris.openMap(mapId)
        routeMap.clearInspect()
        routeMap.resetView()
    }

    function enterNode(nodeId) {
        polaris.openNode(nodeId)
    ...
    RowLayout {
        ...
        Polaris.MapIndex {
            ...
            maps: polaris.maps
            selectedMapId: polaris.selectedMapId
            mapNodes: polaris.nodes
            selectedNodeId: polaris.selectedNode.id || ""
        ...
        Item {
            ...
            Polaris.RouteMap {
                ...
                nodes: polaris.nodes
                edges: polaris.edges
                canvasWidth: polaris.canvasWidth
                canvasHeight: polaris.canvasHeight
                selectedNodeId: polaris.selectedNode.id || ""
            ...
            Polaris.MapHud {
                ...
                visible: !window.nodePageOpen
                nodes: polaris.nodes
                theory: polaris.selectedMapTheory
