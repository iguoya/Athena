...
void LearningStore::save_progress(
    ...
    bind_text(m_handle.get(), statement.raw, 1, function_id);
    if (sqlite3_bind_int(statement.raw, 2, status) != SQLITE_OK
